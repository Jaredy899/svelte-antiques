...
<footer class="border-t border-gray-200 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 py-8 text-black dark:text-gray-300 transition-colors duration-200">
